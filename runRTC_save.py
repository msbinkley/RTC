...
def run_RTC(paramDict, geneName, chrNum, pos, tissue, uuidvalstr):
   ...
   # random.seed(0)
    ...
    posLinked = AS.output_pos_rand_variant2(paramDict["gtexDir"] + "linkedeQTLpos.txt", paramDict, uuidvalstr)
    print("RTC4") #SLOW
    print("pos is ", pos)
    ...
    AS.prepare_perm_file( "/oak/stanford/groups/emoding/scripts/RTCscripts/RTCstuffs/tmpSmall/permutations" + uuidvalstr + ".txt", uuidvalstr)
    print("RTC6") #SLOW
